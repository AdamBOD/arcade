...
if http_cookie_header:
    ...
    if 'sid' in cookie:
        ...
        if session_store.get('authenticated'):
            ...
            result = """<h1 class="snake">Breakout Game</h1>
                <p class="snake">Use the directional arrows on your keyboard to control the platform. Break all the bricks and keep your ball from falling to win the game.</p>
                <main>
                <canvas  height="700px" width="1000px" id="breakout"></canvas>
                </main><br>
                <div class="center">
                <p id="last"><a href="breakout.py"><img src="Restart.png" class="restart"></a></p>
                </div>
                <br>"""
        else :

...
print("""
    <html>
        ...
        <body>
            ...
            <p class="center"><a href="snakestats.py"><img src="Snake_icon.png" class="game"></a><a href="breakoutstats.py"><img src="Breakout_icon.png" class="game"></a><a href="pongstats.py"><img src="Pong_icon.png" class="game"></a></p>
            <footer>

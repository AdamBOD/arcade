(function() {
    ...
    var platform1X = 20, platform1Y = 262.5;
    var platform2X = 970, platform2Y = 262.5;
    var up = false;
    var down = false;
    var w = false;
    var s = false;
    ...
    function keyDownHandler (e) {
        ...
        else if (e.keyCode == 87) { //Moves the right platform up
            w = true;
        }
    ...
    function keyUpHandler (e) {
        ...
        else if (e.keyCode == 87) { //Stops the right platform moving up
            w = false;
        }
    ...
    function draw () { //Draw is the main function to draw all the elements on the canvas; the ball, the bricks, the platform, the score and the lives
    ...
    function platform1 () {
        ctx.beginPath();
        if (w == true && platform1Y > 0) {
            platform1Y -= 3;
            //console.log ("Down")
        }
        if (s == true && platform1Y + platformHeight < height) {
            platform1Y += 3
        }
    ...
    function stop() {
     ...
     clearInterval (loop);
     window.alert(result+"Press R to restart the game or click the button below.");
    }

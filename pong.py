    ...
    if 'sid' in cookie:
        ...
        if session_store.get('authenticated'):
            ...
            result = """<h1 class="snake">Pong Game</h1>
                <p class="snake">The left platform is controled using W and S. The right platform is controled using the Up and Down arrow keys.</p>
                <main>
                <canvas  height="700px" width="1000px" id="pong" class="pong"></canvas>
                </main><br>
                <div class="center">
                <p id="last"><a href="pong.py"><img src="Restart.png" class="restart"></a></p>
                </div>
                <br>"""
        else :

    ...
    if 'sid' in cookie:
        ...
        if session_store.get('authenticated'):
            ...
            result = """<h1 class="snake">Pong Game</h1>
                ...
                <main>
                <canvas  height="700px" width="1000px" id="hardsinglepong" class="pong"></canvas>
                </main><br>
                <div class="center">
                <p id="last"><a href="hardsinglepong.py"><img src="Restart.png" class="restart"></a></p>
                </div>
                <br>"""
        else :
...
print("""
    <html>
        <head>
            <title>Hard Single Pong</title>
            <link rel="stylesheet" type="text/css" href="project.css">
            <link rel="icon" type="image/png" href="logo.png">
            <script src="hardsinglepong.js"></script>
        </head>
        <body>
            <nav id="navbar">%s</nav>
